List sweetsayings = [
   ...
   "अपने जीवन की नायिका बनो, शिकार नहीं",
   "ਆਪਣੀ ਜ਼ਿੰਦਗੀ ਦੀ ਨਾਇਕਾ ਬਣੋ, ਸ਼ਿਕਾਰ ਨਹੀਂ",
   "আপনার জীবনের নায়িকা হন, শিকার নয়",
   "اپنی زندگی کی ہیروئن بنیں، شکار نہیں۔",
   "బాధితురాలిగా కాకుండా మీ జీవితానికి హీరోయిన్‌గా ఉండండి" 
];
